- chore(deps): update taiga-ui dev infra to v0.168.0 (#476) (3464cd7)
- chore(deps): update taiga-ui cdk to v4.3.0 (#482) (053ad5d)
- chore(deps): update nx to v19.7.2 (#481) (48a2206)
- chore(deps): update dependency @nx/linter to v19.7.1 (#480) (697957c)
- chore(deps): update dependency express to v4.20.0 (#479) (b9a9ed5)
- chore(deps): update nx to v19.7.0 (#478) (84bc938)
- chore(deps): update nx to v19.6.6 (#477) (6aef006)
- chore(deps): update taiga-ui dev infra to v0.162.0 (#475) (7e2ebc2)
- chore(deps): update taiga-ui dev infra to v0.161.0 (#474) (fb71683)
- chore(deps): update taiga-ui dev infra to v0.160.1 (#473) (797bb32)
- chore(deps): update taiga-ui dev infra to v0.159.1 (#472) (aa3cb93)
- chore(deps): update taiga-ui dev infra to v0.159.0 (#471) (5315778)

* chore(deps): update taiga-ui dev infra to v0.158.0 (#470) (15ef069)
* chore(deps): update taiga-ui dev infra to v0.157.1 (#469) (bfa3373)
* chore(deps): update taiga-ui dev infra to v0.157.0 (#468) (5217af3)
* chore(deps): update dependency @types/node to v22.5.4 (#467) (13343f5)
* chore(deps): update taiga-ui dev infra to v0.156.1 (#466) (78dc996)
* chore(deps): update taiga-ui dev infra to v0.156.0 (#465) (c9a5a71)
* chore(deps): update taiga-ui dev infra to v0.155.0 (#464) (c329cc3)
* chore(deps): update taiga-ui dev infra to v0.154.0 (#463) (891b043)
* chore(deps): update taiga-ui dev infra to v0.152.1 (#462) (4cb16f6)
* chore(deps): update dependency @types/node to v22.5.3 (#461) (d2beed8)
* chore(deps): update taiga-ui dev infra to v0.152.0 (#460) (43bcb27)
* chore(deps): update nx to v19.6.5 (#459) (928f30c)
* chore(deps): update taiga-ui dev infra to v0.151.0 (#458) (3708e5c)
* chore(deps): update taiga-ui dev infra to v0.149.3 (#457) (93b567c)
* chore(deps): update taiga-ui dev infra to v0.149.2 (#456) (26caf80)
* chore(deps): update taiga-ui dev infra to v0.149.1 (#455) (4862ff1)
* chore(deps): update taiga-family/ci action to v1.71.2 (#454) (0206568)
* chore(deps): update taiga-ui dev infra to v0.149.0 (#453) (59f8927)
* chore(deps): update taiga-ui dev infra to v0.148.0 (#452) (fac6550)
* chore(deps): update taiga-ui dev infra to v0.147.15 (#451) (a9ec9bf)
* chore(deps): update taiga-ui dev infra to v0.147.14 (#450) (25adcc3)
* chore(deps): update taiga-ui dev infra to v0.147.13 (#449) (5290d77)
* chore(deps): update dependency lint-staged to v15.2.10 (#448) (32b466d)
* chore(deps): update dependency @types/node to v22.5.2 (#447) (71ad18c)
* chore(deps): update taiga-ui dev infra to v0.147.12 (#446) (78295f3)
* chore(deps): update taiga-ui dev infra to v0.147.11 (#445) (a5c3f23)
* chore: drop zone.js (7c3814e)
* chore(deps): update taiga-ui dev infra to v0.147.10 (#443) (22318c2)
* chore(deps): update ng to v16.2.15 (#439) (0e506cc)
* chore(deps): update taiga-ui family to v0.147.9 (#441) (4ed676c)
* chore(deps): update taiga-ui family to v0.147.8 (#440) (38a449b)
* chore(deps): update taiga-ui family to v0.147.5 (#438) (dbc2d05)
* chore(deps): update taiga-ui family to v0.147.4 (#437) (e35c228)
* chore(deps): update taiga-ui family to v0.147.3 (#436) (1583888)
* chore(deps): update taiga-family/ci action to v1.71.1 (#435) (0b69dcc)
* chore(deps): update taiga-ui family to v0.147.2 (#434) (3439921)
* chore(deps): update taiga-ui family to v0.147.1 (#433) (a13dbfd)
* chore(deps): update taiga-ui family to v0.147.0 (#432) (0b03c47)

- chore(deps): update dependency @nx/linter to v19.6.4 (#431) (f99ff01)
